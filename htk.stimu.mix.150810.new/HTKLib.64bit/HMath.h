...
//cw564 - stimu
void StimuGrad(NMatrix * srcPtr, int row, int col, NMatrix * grid_suface, int num_phone, NVector * phone_vec, NMatrix *dstPtr, NVector *weight_norms);
...
void ApplyGradMixMeans(NVector* dact, NVector* act, NMatrix* dyFeaMat, NMatrix* mix_surface, NMatrix* raw_y, int batLen, int nodeNum, int comb_dim, int mixnodes, NFloat mean_l2_penalty, NMatrix* phonepos);
...
void MixValidate(NVector *act, int mix_nodes, int len);
