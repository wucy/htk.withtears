...
#ifdef CUDA
                    /*
                    ScaleSilCUDA(dyFeaMat->devElems, layerElem->trainInfo->labMat->devElems, 0.35, 777, batLen, layerElem->nodeNum);
                    ScaleSilCUDA(dyFeaMat->devElems, layerElem->trainInfo->labMat->devElems, 0.35, 778, batLen, layerElem->nodeNum);
                    ScaleSilCUDA(dyFeaMat->devElems, layerElem->trainInfo->labMat->devElems, 0.35, 779, batLen, layerElem->nodeNum);
                    */
#endif
                }
                else {
