...
#else
    HError(9999, "CalcWeightNorms: not support GPU");
#endif
}
...
#else
    HError(9999, "CalcSumActi: not support GPU");
#endif
}


void CalcStimuKL(NVector * klvec, NMatrix * yFeaMats, NVector * weight_norms, NVector * sum_yFeaMats, NMatrix * acti_surface, NVector * phoneidx_vec, int batLen, int nodeNum) {
#ifdef CUDA
    ...
    CalcStimuKLCUDA(klvec_elems, yFeaMats_elems, weight_norms_elems, sum_yFeaMats_elems, acti_surface_elems, phoneidx_vec_elems, batLen, nodeNum);
